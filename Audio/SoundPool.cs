...
namespace Moonvalk.Audio {
	...
	/// </summary>
	[Tool] public class SoundPool : Node {
		/// <summary>
		...
		/// </summary>
		public RandomNumberGenerator Random { get; private set; } = new RandomNumberGenerator();
