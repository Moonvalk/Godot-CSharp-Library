...
namespace Moonvalk.Utilities {
	...
	public abstract class BaseMoonTimer : IMoonTimer {
		...
		/// </summary>
		protected Dictionary<BaseMoonTimerState, InitValue<List<Action>>> _functions;
		#endregion
		...
		public BaseMoonTimer OnComplete(params Action[] tasksToAdd_) {
			this.addTasks(BaseMoonTimerState.Complete, tasksToAdd_);
			return this;
		}
		...
		public BaseMoonTimer OnStart(params Action[] tasksToAdd_) {
			this.addTasks(BaseMoonTimerState.Start, tasksToAdd_);
			return this;
		}
		...
		public BaseMoonTimer OnUpdate(params Action[] tasksToAdd_) {
			this.addTasks(BaseMoonTimerState.Update, tasksToAdd_);
			return this;
		}
		...
		protected void initialize() {
			this._functions = new Dictionary<BaseMoonTimerState, InitValue<List<Action>>>();
			foreach (BaseMoonTimerState state in Enum.GetValues(typeof(BaseMoonTimerState))) {
		...
		protected void addTasks(BaseMoonTimerState state_, params Action[] tasksToAdd_) {
