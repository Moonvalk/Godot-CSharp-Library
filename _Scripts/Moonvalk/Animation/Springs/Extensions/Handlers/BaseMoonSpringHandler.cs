...
namespace Moonvalk.Animation {
	...
	public abstract class BaseMoonSpringHandler<Unit, SpringType, ParentType> : IMoonSpringHandler
		...
		/// </summary>
		public MoonSpringProperty Property { get; private set; }
		...
		/// </summary>
		public SpringType Spring { get; private set; }
		...
		protected void setupSpring(Unit target_, MoonSpringParams parameters_, bool start_, Action onComplete_) {
			this.Spring = new SpringType() { StartOnTargetAssigned = start_ };
			this.Spring.SetReferences(() => ref this._value).SetParameters(parameters_);
		...
		protected abstract Unit getInitialPropertyValue(ref ParentType object_, MoonSpringProperty property_);
	}
}
