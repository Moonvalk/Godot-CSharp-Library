...
namespace Moonvalk.Nodes {
	...
	public class SpringCursorController : Node {
		...
		/// <summary>
		/// Path to the cursor image node.
		/// </summary>
		[Export] protected NodePath p_cursorImage { get; set; }
		...
		public override void _Ready() {
			this.Cursor = this.GetNode<Control>(p_cursorImage);
			...
			this.MovementSpring = new MoonSpringVec2(() => ref this._currentPosition) { StartOnTargetAssigned = true };
